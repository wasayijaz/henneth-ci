...
## 4. The four app scheduled tasks (`~/.claude/scheduled-tasks/`)
...
| Task | When (PKT) | Does |
|---|---|---|
| `psx-desk-hourly-cycle` | weekdays, market hours | data + **news-sentinel** + position **monitor**; escalates to full commentary only on impact ≥ 4 news |
