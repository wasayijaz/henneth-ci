...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="henneth-hist-seed-") as tmp:
        ...
        cases = {
            ...
            "interim_period": _valid_doc(period={"period_type": "interim", "period_end": "2024-06-30"}),
            "non_annual_title": _valid_doc(title="Transmission of Financial Statements for 2024"),
            "title_year_mismatch": _valid_doc(title="Transmission of Annual Report for the year ended June 30, 2023"),
