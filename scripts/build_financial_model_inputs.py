...
def build():
    ...
    result={'schema_version':1,'pilot_symbols':sorted(pilot),'companies':out,'source':'state/company_financial_series.json','model_registry_source':'scripts/sector_driver_models.py','model_adapter_source':None}; save_json(OUT,result); print(f'financial_model_inputs: {len(out)} companies'); return result
