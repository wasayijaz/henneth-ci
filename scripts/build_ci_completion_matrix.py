    ...
    rows = [
        ...
        _row(
            ...
            [
                ...
                _contains("current parser revision", "scripts/check_financial_model_inputs.py", ("financial_statement_v2", "block_geometry_v4")),
            ],
        ...
        _row(
            ...
            ["Three qualified periods per company are required before input_ready can become live evidence."],
        ),
        _row(
            "forecast_readiness_live_inputs",
