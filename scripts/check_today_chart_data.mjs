...
const context = { window: { devicePixelRatio: 1 }, document: { addEventListener(name, fn) { documentHandlers[name] = fn; }, getElementById() { return null; }, createElement() { return { id: "", textContent: "" }; }, head: { appendChild() {} }, body: {} }, getComputedStyle() { return { color: "#1f211d", getPropertyValue() { return ""; } }; }, console, Math, JSON, String, Number, Object, Array, Set, setTimeout, clearTimeout };
